...
root.dir = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Goblet_ADC/"
rds = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Goblet_ADC/Airway_goblet.rds"
...
# new_cl = c()
# 
# for (i in names(cl$cluster)) {
#   new_cl[[i]] = cutree(temp, 5)[[cl$cluster[i]]]
# }
