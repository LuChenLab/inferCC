...
root.dir = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Goblet_SCC"
rds = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Goblet_SCC/Airway_goblet.rds"
...
#   new_cl[[i]] = cutree(temp, 4)[[cl$cluster[i]]]
# }
