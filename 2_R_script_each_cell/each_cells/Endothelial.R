...
# if the image direcotory not exists, create it
image_dir = here("02_figures_each_cell/Endothelial")
input_rds = here("00_data_ingest/04_rds_generated/seurat_obj/Endothelial.rds")
...
legend("bottomleft", c("Normal", "CPI", "Benign", "I", "II", "III",'IV'), 
