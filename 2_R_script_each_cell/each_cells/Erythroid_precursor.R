...
# if the image direcotory not exists, create it
image_dir = here("02_figures_each_cell/Erythroid_precursor")
input_rds = here("00_data_ingest/04_rds_generated/seurat_obj/Erythroid_precursor.rds")
...
meta = obj@meta.data[obj@meta.data$Batch != 3 & obj@meta.data$Disease %in% c("ADC", "SCC", "LELC", "LCC"),]
