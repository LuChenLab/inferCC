...
# if the image direcotory not exists, create it
image_dir = here("02_figures_each_cell/Alveolar_II")
...
legend("topright", c("Benign", "Normal", "I", "II", "III",'IV'), 
       col=sapply(c("Benign", "Normal", "I", "II", "III", "IV"), function(x){colors[x]}), 
       text.col="black", pch=16, bty="n", cex=1, ncol=2)
