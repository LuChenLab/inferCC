...
# if the image direcotory not exists, create it
image_dir = here("02_figures_each_cell/Ciliated_tumor")
input_rds = here("00_data_ingest/04_rds_generated/seurat_obj/Ciliated.rds")
...
meta = obj@meta.data[obj@meta.data$Batch != 3 & obj@meta.data$Disease %in% c("ADC", "SCC", "LELC"),]
...
p <- make_combined_barplot(selected_obj, rel_height = c(0.3, 1), with_disease = T)
...
legend("bottomleft", legends, col=cols_for_legend, 
