...
image_dir = here("02_figures_each_cell/Basal_SCC")
...
meta = obj@meta.data[obj@meta.data$Batch != 3 & obj@meta.data$PatientID != "P01" & obj@meta.data$Disease == "SCC",]

meta = as.data.frame(meta %>% select(PatientID, Sex, Stage, Disease, Age))
...
saveRDS(selected_obj, "Basal.rds")
...
genes <- c("LY6D", "C6orf141", "IL32", "UBD", "NPPC", "IER2", "SRGN", "CCL20", "JUNB")
