...
VlnPlot(ap2, features.plot = intersect(rownames(ap2@raw.data), sort(c("G6PD", "SERPINB9", meta2$Symbol))), group.by = "res.0.6")
```

```{r fig.height=12, fig.width=18}
VlnPlot(basal, features.plot = intersect(rownames(basal@raw.data), sort(c("G6PD", "SERPINB9", meta2$Symbol))), group.by = "res.0.6")
```
