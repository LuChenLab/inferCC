;(function() {
	...
	if(c){ 
		...
		if (!elPh) return;
		elPh.innerHTML = "";
		var elFr = document.createElement("iframe");
		elFr.src = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/emyncbi.fcgi?cmd=htmlportal&currenturl=" + encodeURIComponent(document.location.href);		
		elFr.setAttribute("style", "border:none; height:2.5em; width:40em;");
		elFr.setAttribute("scrolling", "no");
		elPh.appendChild(elFr);
		elPh.style.top = "-0.4em";
	}
})();
