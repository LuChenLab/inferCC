...
root.dir = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Granulocyte_SCC/"
rds = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Granulocyte_SCC/Granulocyte.rds"
...
new_cl = perform_mfuzz(expr, cluster_markers, logfc=logfc, qvalue=qvalue, init_cluster = 5)
