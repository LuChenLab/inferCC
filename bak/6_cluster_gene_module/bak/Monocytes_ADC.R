...
root.dir = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Monocytes_ADC/"
rds = "/mnt/raid62/Lung_cancer_10x/02_figures_each_cell/Monocytes_ADC/Monocytes.rds"
...
new_cl = perform_mfuzz(expr, cluster_markers, logfc=logfc, qvalue=qvalue, init_cluster = 6)
