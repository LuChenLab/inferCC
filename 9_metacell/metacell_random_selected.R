...
base_dir = "huaxi_selected"

dir.create(base_dir, showWarnings = F, recursive = T)


obj <- readRDS("/mnt/raid62/Lung_cancer_10x/00_data_ingest/04_rds_generated/metacell_random_selected_raw.rds")
...
object = mat
save(object, file="/mnt/raid62/Lung_cancer_10x/MetaCell/huaxi_selected/mat.huaxi_selected.Rda")

print(dim(mat@mat))

# set image output directory
figs_dir = "/mnt/raid62/Lung_cancer_10x/MetaCell/huaxi_selected/figs"
