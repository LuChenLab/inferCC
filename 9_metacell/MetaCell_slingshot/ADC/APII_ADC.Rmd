...
```{R}
data = read.csv("/mnt/raid62/Lung_cancer_10x/MetaCell/lfp/By_cells/Alveolar_II_ADC_mc_f.log2_mc_fp.txt", row.names = 1)
...
```{R}
ggsave(
    filename = "/mnt/raid62/Lung_cancer_10x/MetaCell/By_cells_heatmaps/Alveolar_II_ADC/metacell_slingshot.png",
    plot = p1,
    width = 7,
    height = 6,
    units = "in",
