...
```{R}
data = read.csv("/mnt/raid62/Lung_cancer_10x/MetaCell/lfp/By_cells/Monocytes_ADC_mc_f.log2_mc_fp.txt", row.names = 1)


meta <- read.csv("/mnt/raid62/Lung_cancer_10x/00_data_ingest/03_annotation_csv/20190506_meta.csv", row.names = 1)
load("/mnt/raid62/Lung_cancer_10x/MetaCell/By_cells/Monocytes_ADC/mc.Monocytes_ADC_mc_f.Rda")
mc = object
```
...
```{R}
ggsave(
    filename = "/mnt/raid62/Lung_cancer_10x/MetaCell/By_cells_heatmaps/Monocytes_ADC/metacell_slingshot.png",
    plot = p1,
    width = 7,
    height = 6,
    units = "in",
