...
base_dir = "NM_selected"

dir.create(base_dir, showWarnings = F, recursive = T)
figs_dir = "/mnt/raid62/Lung_cancer_10x/MetaCell/NM_selected/figs"
...
obj <- readRDS("/mnt/raid62/Lung_cancer_10x/00_data_ingest/04_rds_generated/metacell_random_selected_NM.rds")
...
object = mat
save(object, file="/mnt/raid62/Lung_cancer_10x/MetaCell/NM_selected/mat.NM_selected.Rda")
...
#############
# ZeminZhang Guo 2018 data processing
mat <- read.table("/mnt/raid62/Lung_cancer_10x/00_data_ingest/00_raw_data/guo2018/GSE99254_NSCLC.TCell.S12346.count.txt", header = T)
mat <- na.omit(mat)
...
object = mat
save(object, file="/mnt/raid62/Lung_cancer_10x/MetaCell/Guo2018/mat.Guo2018.Rda")

print(dim(mat@mat))

# set image output directory
figs_dir = "/mnt/raid62/Lung_cancer_10x/MetaCell/Guo2018/figs"
...
plot(density(log10(rowSums(obj@raw.data) + 1)))
plot(density(log10(colSums(obj@raw.data) + 1)))

mcell_mat_ignore_small_cells(base_dir, base_dir, 500)
