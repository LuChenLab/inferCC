...
# meta <- read.xlsx("/mnt/data5/zhangyiming/seurat/results/LungCancer10X_table1.xlsx", sheet = 3)

meta <- read.xlsx("/mnt/raid61/Personal_data/zhangyiming/LungCancer10X_table1.xlsx", sheet = 3)
...
# Amacrine 
library(MASS)
input_dir = "/mnt/data5/zhangyiming/seurat/results/cluster/"
